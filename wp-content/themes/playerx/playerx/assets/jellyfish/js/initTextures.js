...
function initTextures() {
  loadTexture('jellyfish', 'wp-content/themes/playerx/playerx/assets/jellyfish/images/jellyfish.png');
  loadTexture('luminescence', 'wp-content/themes/playerx/playerx/assets/jellyfish/images/luminescence.png');

  for (var i=1; i <= 32; i++) {
    loadTexture('caustics'+i, 'wp-content/themes/playerx/playerx/assets/jellyfish/images/caustics/caustics7.'+pad2(i-1)+'.jpg');
  }
}
